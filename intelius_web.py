...
for i in range(len(inputData)):
    ...
    dr.get("https://www.intelius.com/people-search")
    elemFirstName = dr.find_element_by_id("peopleSearch_firstName")
    elemLastName = dr.find_element_by_id("peopleSearch_lastName")
    print(inputData[i])
